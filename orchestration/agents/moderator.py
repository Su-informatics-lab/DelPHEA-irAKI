...
class irAKIModeratorAgent(RoutedAgent):
    ...
    def _consolidate_recommendations(self) -> List[str]:
        ...
        return sorted(list(all_recommendations))[:5]
